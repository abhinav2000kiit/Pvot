    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <input
          style={Object.assign(
            {
              width: this.props.boxwidth ? this.props.boxwidth : '1em',
              textAlign: 'center',
              fontSize: '1.25rem',
              borderLeft: '2px solid #999',
              borderTop: '2px solid #999',
              borderBottom: '2px solid #999',
              borderRight: this.props.serial === this.props.total - 1 ? '2px solid #999' : 0,
              padding: '0.75rem 0',
              borderBottomLeftRadius: this.props.serial === 0 ? '2rem' : 0,
              borderTopLeftRadius: this.props.serial === 0 ? '2rem' : 0,
              borderBottomRightRadius: this.props.serial === this.props.total - 1 ? '2rem' : 0,
              borderTopRightRadius: this.props.serial === this.props.total - 1 ? '2rem' : 0
            },
