...
const Trades = props => {
  ...
  return (
    <Zoom in={true} timeout={200}>
      <div>
        <Header title={props.tradeItem ? 'Edit Trade' : 'New Order'} crossIcon />
        <div>
            ...
            <Formik
              ...
              render={({
                ...
                <form onSubmit={handleSubmit}>
                  <Paper style={{ padding: '20px' }} className='fullSection'>
                    {/*************************************************** Trade Type ******************************************************/}
                    <div>
                      <span className='labels'>Trade Type</span>
                      <Row>
                        {tradeType.map(t => (
                    ...
                    {/*************************************************** Duration ******************************************************/}
                    <div className='my-2'>
                      <span className='labels mt-4'>Duration</span>
                      <Row className='mt-2'>
                        {duration.map(t => (
                          <Col lg={6} md={6} sm={6} xs={6} style={{ padding: '5px' }}>
                            <Box
                    ...
                    {/*************************************************** Complexity ******************************************************/}
                    <div className='my-2'>
                      <span className='labels mt-4'>Complexity</span>
                      <Row className='mt-2'>
                        {complexity.map(t => (
                    ...
                    <Row style={{ marginTop: '10px', display: 'flex', justifyContent: 'space-between' }}>
                      <Col lg={6} md={6} sm={6} xs={6} style={{ padding: '4px' }}>
                        <FormControl className={classes.formControl}>
                          <TextField
                            name='orderPrice'
                    ...
                    <Row style={{ marginTop: '10px', display: 'flex', justifyContent: 'space-between' }}>
                      <Col lg={6} md={6} sm={6} xs={6} style={{ padding: '4px' }}>
                        <FormControl className={classes.formControl}>
                          ...
                          <p className='input-helper'>{lotSize ? `Multiple of ${lotSize} units` : ` In Units `}</p>
                        </FormControl>
                      </Col>
                      <Col lg={6} md={6} sm={6} xs={6} style={{ padding: '4px' }}>
                        {virtualTradeObject.tradeType === 'Investment' ||
                        (props.tradeItem && props.tradeItem.segment.name === 'INVESTMENT') ? null : (
                          <FormControl className={classes.formControl}>
                            ...
                            <p className='input-helper'>
                              {virtualTradeObject.complexity === 'CO'
                                ? `Range =  ${((values.orderPrice * 98.5) / 100).toFixed(2)} - ${(
                                    (values.orderPrice * 101.5) /
                                    100
                                  ).toFixed(2)} depending on Buy/Sell`
                                : 'In Rupees'}
                            </p>
                          </FormControl>
                        )}
                    ...
                    {props.loader ? (
                        ...
                        <Col className='mx-auto'>
                          <Button
                            ...
                            className={
                              ...
                              stockSelected
                                ? 'submitButtons buyButton '
                                : 'submitButtons disabledBuyButton'
                            }
                          ...
                          >
                            <span className='buttonFont'>Buy</span>
                          </Button>
                        </Col>
                        <Col className='mx-auto'>
                          <Button
                            ...
                            className={
                              ...
                              virtualTradeObject.complexity &&
                              stockSelected
                                ? 'submitButtons sellButton '
                                : 'submitButtons disabledSellButton'
                            }
                          ...
                          >
                            <span className='buttonFont'>Sell</span>
                          </Button>
                        </Col>
                      </Row>
                    ) : (
                      <Row>
                        <Button
                          ...
                          className='submitButtons buyButton '
                          //onClick={submitForm}
                        >
                          Modify
                        </Button>
