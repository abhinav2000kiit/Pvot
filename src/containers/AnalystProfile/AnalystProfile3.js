              ...
              <Col className='center-col-special'>
                ...
                <Row className='ImageSection'>
                  <Col className='center-col'>
                    ...
                    <Row className='followerSection align-content-center justify-content-center'>
                      <div
                        onClick={() => this.props.history.push('/followers', { list: 'Followers' })}
                        className='col-5'
                      >
                      ...
                      <div
                        onClick={() => this.props.history.push('/subscribers', { list: 'Subscribers' })}
                        className='col-5'
                      >
                        <Row className='mt-3 justify-content-center'>
                          <div className='followerCount'>
                  ...
                  <Row className='mb-5'>
                    <Col align='center' className=''>
                      <button
                        ...
                        onClick={() => this.props.history.push('/user-manual')}
                      >
                ...
                <div className='bottomSection mx-auto'>
                  <Row className='mt-2 text-center'>
                    {this.state.fetchingReferralCode ? (
                      <Col className='col-4 offset-4'>
                        <CircularProgress size='1rem' color='primary' />
                      </Col>
                    ) : (
                      <Col
                        onClick={this.fetchReferralCode.bind(this)}
                        className='col-6 offset-3 text-center color-blue'
                      >
                        Refer a friend
                      </Col>
                    )}
